...
interface Props { current: string; onChange: (id: string)=>void; role?: string; }
...
const ADMIN_TABS: Tab[] = [
  { id:'home',           icon:'home',  label:'Home'     },
  { id:'courses',        icon:'book',  label:'Courses'  },
  { id:'adminStudents',  icon:'user',  label:'Students' },
  { id:'adminSession',   icon:'scan',  label:'Sessions' },
  { id:'adminRewards',   icon:'star',  label:'Rewards'  },
];

const BottomNav: React.FC<Props> = ({ current, onChange, role }) => {
